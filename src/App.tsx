...
import LoginOCID from "./pages/LoginOCID";
  ...
  return (
    <OktoProvider config={config}>
      ...
      <Suspense
        fallback={
          <div
            className="flex justify-center items-center text-3xl text-[#03257e] font-bold h-[80vh]"
            data-aos="zoom-in"
          >
            Loading{" "}
      ...
      >
        <Routes>
          <Route path="/" element={<Home handlerLogout={handlerLogout} />} />
          <Route path="/invalid-token" element={<InvalidTokenModal open redirectUrl="/login" />} />
          ...
          <Route path="/loginOCID" element={<LoginOCID />} />
